    ...
    return
      new Scaffold(
        ...
        appBar: new AppBar(
          ...
          title: new Text('Data Channel Test', style: TextStyle(color: Colors.white70),),
        ),
        body: new OrientationBuilder(
          builder: (context, orientation) {
            return new Center(
              child: new Container(
                child: _inCalling? Text(_sdp) : Text('data channel test', style: TextStyle(color: Colors.white70),),
              ),
            );
          },
        ),
        floatingActionButton: new FloatingActionButton(
          backgroundColor: Color(0xFF5770aa),
